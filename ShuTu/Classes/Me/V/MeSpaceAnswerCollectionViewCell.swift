//
//  MeSpaceAnswerCollectionViewCell.swift
//  ShuTu
//
...
class MeSpaceAnswerCollectionViewCell: FSPagerViewCell {

    @IBOutlet weak var tableView: UITableView! {
        didSet {
            self.tableView.register(UINib(nibName: "MeSpaceAnswerTableViewCell", bundle: nil), forCellReuseIdentifier: "answer")
    ...
    open var viewModel: MeSpaceAnswerViewModel! {
        didSet {
            self.bindRx()
        }
    }
    ...
    //私有成员
    fileprivate var dataSource: RxTableViewSectionedReloadDataSource<MeSpaceAnswerSectionModel>!
    fileprivate var emptyView: EmptyView!
    
}

extension MeSpaceAnswerCollectionViewCell {
    //初始化
    ...
    fileprivate func bindRx() {
        ...
        dataSource = RxTableViewSectionedReloadDataSource<MeSpaceAnswerSectionModel>(
            configureCell: { ds, tv, ip, item in
                let cell = tv.dequeueReusableCell(withIdentifier: "answer", for: ip) as! MeSpaceAnswerTableViewCell
...
extension MeSpaceAnswerCollectionViewCell: UITableViewDelegate, EmptyViewDelegate {
