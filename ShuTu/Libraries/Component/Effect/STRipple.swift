...
public extension UIView {
    ...
    public func rippleBorder(_ location:CGPoint, _ color:UIColor, _ then: @escaping ()->() ) {
        STRipple.border(self, locationInView: location, color: color, then: then)
    }
    ...
    public func rippleFill(_ location:CGPoint, _ color:UIColor, _ then: @escaping ()->() ) {
        STRipple.fill(self, nil, locationInView: location, color: color, then: then)
    }
    
    public func rippleFill(_ radius: CGFloat, _ location:CGPoint, _ color:UIColor, _ then: @escaping ()->() ) {
        STRipple.fill(self, radius, locationInView: location, color: color, then: then)
    }
...
public class STRipple {
    ...
    private class func prePreform(_ view:UIView, point:CGPoint, option: STRipple.Option, then: @escaping ()->() ) {
...
//        }
    ...
    private class func perform(_ parent: UIView, _ view:UIView, point:CGPoint, option: STRipple.Option, then: @escaping ()->() ) {
