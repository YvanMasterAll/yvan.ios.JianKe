...
@objc public protocol STSlideMenuControllerDelegate {
...
public struct STSlideMenuOptions {
    ...
    public static var rightBezelWidth: CGFloat? = 32.0
...
open class STSlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open weak var delegate: STSlideMenuControllerDelegate?
    ...
    open func initView() {
        ...
        opacityView.backgroundColor = STSlideMenuOptions.opacityViewBackgroundColor
        ...
        if leftViewController != nil {
            ...
            leftFrame.size.width = STSlideMenuOptions.leftViewWidth
        ...
        if rightViewController != nil {
            ...
            rightFrame.size.width = STSlideMenuOptions.rightViewWidth
    ...
    open func addLeftGestures() {
        ...
        if leftViewController != nil {
            if STSlideMenuOptions.panGesturesEnabled {
            ...
            if STSlideMenuOptions.tapGesturesEnabled {
    ...
    open func openLeftWithVelocity(_ velocity: CGFloat) {
        ...
        var duration: TimeInterval = Double(STSlideMenuOptions.animationDuration)
        if velocity != 0.0 {
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: STSlideMenuOptions.animationOptions, animations: { [weak self]() -> Void in
            if let strongSelf = self {
                strongSelf.leftContainerView.frame = frame
                strongSelf.opacityView.layer.opacity = Float(STSlideMenuOptions.contentViewOpacity)
                
                STSlideMenuOptions.contentViewDrag == true ? (strongSelf.mainContainerView.transform = CGAffineTransform(translationX: STSlideMenuOptions.leftViewWidth, y: 0)) : (strongSelf.mainContainerView.transform = CGAffineTransform(scaleX: STSlideMenuOptions.contentViewScale, y: STSlideMenuOptions.contentViewScale))
    ...
    open func openRightWithVelocity(_ velocity: CGFloat) {
        ...
        //    CGFloat finalXOrigin = STSlideMenuOptions.rightViewOverlapWidth
        ...
        UIView.animate(withDuration: duration, delay: 0.0, options: STSlideMenuOptions.animationOptions, animations: { [weak self]() -> Void in
            if let strongSelf = self {
                ...
                STSlideMenuOptions.contentViewDrag == true ? (strongSelf.mainContainerView.transform = CGAffineTransform(translationX: -STSlideMenuOptions.rightViewWidth, y: 0)) : (strongSelf.mainContainerView.transform = CGAffineTransform(scaleX: STSlideMenuOptions.contentViewScale, y: STSlideMenuOptions.contentViewScale))
            }
        }) { [weak self](Bool) -> Void in
            if let strongSelf = self {
                strongSelf.disableContentInteraction()
    ...
    open func pushViewControllerFromMain(_ viewController: UIViewController,  close: Bool) {
    ...
    open func changeLeftViewWidth(_ width: CGFloat) {
        ...
        STSlideMenuOptions.leftViewWidth = width
        var leftFrame: CGRect = view.bounds
    ...
    open func changeRightViewWidth(_ width: CGFloat) {
        ...
        STSlideMenuOptions.rightBezelWidth = width
        var rightFrame: CGRect = view.bounds
    ...
    fileprivate func leftMinOrigin() -> CGFloat {
        return  -STSlideMenuOptions.leftViewWidth
    }
    ...
    fileprivate func panLeftResultInfoForVelocity(_ velocity: CGPoint) -> PanInfo {
        ...
        let pointOfNoReturn: CGFloat = CGFloat(floor(leftMinOrigin())) + STSlideMenuOptions.pointOfNoReturnWidth
    ...
    fileprivate func panRightResultInfoForVelocity(_ velocity: CGPoint) -> PanInfo {
        ...
        let thresholdVelocity: CGFloat = -1000.0
        let pointOfNoReturn: CGFloat = CGFloat(floor(view.bounds.width) - STSlideMenuOptions.pointOfNoReturnWidth)
    ...
    fileprivate func applyLeftOpacity() {
        ...
        let opacity: CGFloat = STSlideMenuOptions.contentViewOpacity * openedLeftRatio
    ...
    fileprivate func applyRightOpacity() {
        ...
        let opacity: CGFloat = STSlideMenuOptions.contentViewOpacity * openedRightRatio
        opacityView.layer.opacity = Float(opacity)
    }
    
    fileprivate func applyLeftContentViewScale() {
        let openedLeftRatio: CGFloat = getOpenedLeftRatio()
        let scale: CGFloat = 1.0 - ((1.0 - STSlideMenuOptions.contentViewScale) * openedLeftRatio)
        let drag: CGFloat = STSlideMenuOptions.leftViewWidth + leftContainerView.frame.origin.x
        
        STSlideMenuOptions.contentViewDrag == true ? (mainContainerView.transform = CGAffineTransform(translationX: drag, y: 0)) : (mainContainerView.transform = CGAffineTransform(scaleX: scale, y: scale))
    }
    
    fileprivate func applyRightContentViewScale() {
        let openedRightRatio: CGFloat = getOpenedRightRatio()
        let scale: CGFloat = 1.0 - ((1.0 - STSlideMenuOptions.contentViewScale) * openedRightRatio)
    ...
    fileprivate func addShadowToView(_ targetContainerView: UIView) {
        ...
        targetContainerView.layer.shadowOffset = STSlideMenuOptions.shadowOffset
        targetContainerView.layer.shadowOpacity = Float(STSlideMenuOptions.shadowOpacity)
        targetContainerView.layer.shadowRadius = STSlideMenuOptions.shadowRadius
    ...
    fileprivate func addContentOpacity() {
        opacityView.layer.opacity = Float(STSlideMenuOptions.contentViewOpacity)
    }
    ...
    fileprivate func setOpenWindowLevel() {
        if STSlideMenuOptions.hideStatusBar {
    ...
    open func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldRecognizeSimultaneouslyWith otherGestureRecognizer: UIGestureRecognizer) -> Bool {
        return STSlideMenuOptions.simultaneousGestureRecognizers
    }
    
    fileprivate func slideLeftForGestureRecognizer( _ gesture: UIGestureRecognizer, point:CGPoint) -> Bool{
        return isLeftOpen() || STSlideMenuOptions.panFromBezel && isLeftPointContainedWithinBezelRect(point)
    }
    
    fileprivate func isLeftPointContainedWithinBezelRect(_ point: CGPoint) -> Bool{
        if let bezelWidth = STSlideMenuOptions.leftBezelWidth {
    ...
    fileprivate func slideRightViewForGestureRecognizer(_ gesture: UIGestureRecognizer, withTouchPoint point: CGPoint) -> Bool {
        return isRightOpen() || STSlideMenuOptions.rightPanFromBezel && isRightPointContainedWithinBezelRect(point)
    }
    
    fileprivate func isRightPointContainedWithinBezelRect(_ point: CGPoint) -> Bool {
        if let rightBezelWidth = STSlideMenuOptions.rightBezelWidth {
...
extension UIViewController {
    ...
    public func slideMenuController() -> STSlideMenuController? {
        var viewController: UIViewController? = self
        while viewController != nil {
            if viewController is STSlideMenuController {
                return viewController as? STSlideMenuController
            }
