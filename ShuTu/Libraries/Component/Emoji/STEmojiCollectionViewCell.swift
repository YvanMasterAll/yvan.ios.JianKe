//
//  STEmojiCollectionViewCell.swift
//  ShuTu
//
...
typealias STEmojiCollectionViewCellBlock = (_ imageUrl: String) -> ()

class STEmojiCollectionViewCell: UICollectionViewCell {

    @IBOutlet weak var emoji: UIImageView!
    
    //MARK: - 声明区域
    open var imageUrl: String!
    open var block: STEmojiCollectionViewCellBlock?
...
extension STEmojiCollectionViewCell {
