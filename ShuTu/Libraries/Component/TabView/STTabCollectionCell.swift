...
class STTabCollectionCell: UICollectionViewCell {

    var tabItemButtonPressedBlock: (() -> Void)?
    var option: STTabPageOption = STTabPageOption() {
        didSet {
