...
@objc public protocol STGrowingTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: STGrowingTextView, height: CGFloat)
}

@IBDesignable @objc
open class STGrowingTextView: UITextView {
    
    //MARK: - General Apperance
    ...
    //MARK: - Calculate and adjust textview's height
    ...
    override open func layoutSubviews() {
        ...
        if self.isGrowing {
            ...
            if height != heightConstraint!.constant {
                ...
                if let delegate = delegate as? STGrowingTextViewDelegate {
    ...
    @objc func textDidEndEditing(notification: Notification) {
        if let notificationObject = notification.object as? STGrowingTextView {
    ...
    @objc func textDidChange(notification: Notification) {
        if let sender = notification.object as? STGrowingTextView, sender == self && self.isGrowing {
