...
//  Copyright © 2017 STButton. All rights reserved.
//
...
open class STButton: UIButton {
    ...
    @IBInspectable open override var shadowOpacity: Double {
        get {
    ...
    func setupGradient(){
        guard gradientEnabled != false else{ return }
    ...
    @objc func tapped(sender: STButton) {
        self.action?()
    }
...
extension STButton: CAAnimationDelegate{
